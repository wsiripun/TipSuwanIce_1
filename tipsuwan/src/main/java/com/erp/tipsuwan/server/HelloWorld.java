...
// http://localhost:8080/tipsuwan/tutorial/...		// 'tutorial' is the base.
// (Assume that the war file is 'tipsuwan.war')
@Path("tutorial")
public class HelloWorld
{
	// Tomcat is at port 591.
	// URL:  http://localhost:591/tipsuwan/tutorial/helloworld
    @GET
    @Path("helloworld")
    public String helloworld() {
        return "TipSuwan  Hello World! Tomcat 8.5 Port 591";
    }
    
    // URL:  http://localhost:591/tipsuwan/tutorial/helloname/francesco123f
    @GET
    @Path("helloname/{name}")
...
// CLIENT CODES:
//
//	$.post("/tipsuwan/tutorial/multipleparms",
//	        {
//	          parm1: "post call",
//	          parm2: 12345,
//	          parm3: true
...
//		$.ajax({
//		    type: 'POST',
//		    url: '/tipsuwan/tutorial/multipleparms',
